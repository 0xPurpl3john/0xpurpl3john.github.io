...
image: https://0xch4rli3.github.io/assets/img/Vulnhub/brainpan/capa.png
---
...
Dentro do diretório `/bin` foi encontrado o arquivo `brainpan.exe` que ao ser testado com a ferramenta ****wine,**** mostrou-se ser o serviço que estava funcionando na porta 9999, conforme apresentado nas figuras X, X e X
...
Após, comecei testes com quantidades diferentes de strings até que fosse possível quebrar o programa, de acordo com as imagens a seguir.
...
Conforme a figura X, o EIP foi corretamente preenchido com as strings “B”. Com isso, nosso controle do EIP está garantido.
...
Com base na resposta do *mona* na figura X, foi percebido que havia o `\x00\` como um *badchar.* A partir disso, foram repetidos os passos anteriores porém, utilizando o parâmetro *-b* e o *badchar.*
...
Como visualizado na figura X, foi encontrado o *opcode* JMP ESP e o mesmo possui os parâmetros 311712F3 e estes, devem ser passados, ao contrário, para nosso script no parâmetro *retn* conforme apresentado na figura X.
...
Executando o script da figura X e utilizando o *nc* como o listener da porta 1337, entramos na máquina.
